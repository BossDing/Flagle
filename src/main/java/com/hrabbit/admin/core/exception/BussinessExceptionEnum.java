...
public enum BussinessExceptionEnum {
    ...
    CANT_ROLE_HAVECHILD(408,"请先删除子角色信息"),
    ...
    public static String valueOf(Integer value) {
        if (value == null) {
            ...
            for (BussinessExceptionEnum bizLogType : BussinessExceptionEnum.values()) {
                if (bizLogType.getCode().equals(value)) {
